...
$ACCESS_TOKEN = 'wwBF2eutzBp1bxBf+EkOpwvU/+vXyqG1JxaNNv2EO87WRx0uaLB3F3/viEldnDykjvViSRSAUuP6wjv57Ag8u94+loZW0CKzVbkeByusQ/ab3J1FuroEJPEFVfyMGMf9XoksPxoRM1WEx4BJy7B6EAdB04t89/1O/w1cDnyilFU='; // Access Token ค่าที่เราสร้างขึ้น
   ...
   if( $event['message']['type'] == 'text' )
   {
		$text = $event['message']['text'];
	   	...
	   	if($text == "ชื่อ" || $text == "ชื่ออะไร" || $text == "ชื่ออะไรครับ"|| $text == "ชื่ออะไรคะ"){
			$reply_message = 'ชื่อของฉันคือ ANGRYBOT';
		}
